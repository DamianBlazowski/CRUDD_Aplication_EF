...
public partial class NorthwindContext : DbContext
{
    ...
    static void MeasureTime()
    {
        ...
        zegar.Stop();
        var milisekundy = zegar.ElapsedMilliseconds;

        Console.WriteLine("Czas wynosi: {0}ms", milisekundy);
    }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-1MAQ4AD\\TEW_SQLEXPRESS; Initial Catalog=Northwind; Integrated Security=True; Connect Timeout=30; Encrypt=False;");
